    ...
    <div id="about" className="bg-[#ffffff] min-h-screen flex items-center">
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        ...
        <p className="text-lg md:text-xl text-gray-700 text-center leading-relaxed">
          I’m <span className="font-bold text-[#fe5617]">Akash Kanna</span>,
         BCA Graduate with a passion for coding and Web development .Proficient in HTML , CSS ,BOOTSTRAP and
            foundamental knowledge in JAVASCRIPT Basic and REACT.JS Basic.I aim to leverage my skills to create
            innovative digital solutions .I am dedicated to continuous learing and seeking for good opportunities to
